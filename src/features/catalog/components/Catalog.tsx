...
import { CatalogList } from './listing/CatalogList'
        ...
        <>
            <div className="flex min-h-0 flex-1">
                ...
                <main className="flex min-w-0 flex-1 flex-col bg-catalog">
                    ...
                    <Pagination page={safePage} totalPages={totalPages} totalItems={filtered.length} start={filtered.length ? (safePage - 1) * pageSize + 1 : 0} end={Math.min(safePage * pageSize, filtered.length)} pageSize={pageSize} onPage={setPage} onPageSizeChange={changePageSize} />
                </main>
