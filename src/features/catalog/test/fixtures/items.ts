...
export const ITEM_FIXTURES: Item[] = [
    {
        id: 'bag-of-holding', name: 'Bag of Holding', icon: '🎒', type: 'Magic', rarity: 'Uncommon', category: 'Bag/Container', categories: ['Bag/Container'], subtype: 'Container',
    ...
    {
        id: 'pearl-of-power', name: 'Pearl of Power', icon: '💎', type: 'Magic', rarity: 'Uncommon', category: 'Gem', categories: ['Gem'], subtype: 'Pearl',
    ...
    {
        id: 'vicious-longsword', name: 'Vicious Longsword', icon: '⚔️', type: 'Magic', rarity: 'Rare', category: 'Weapon', categories: ['Weapon'], subtype: 'Longsword',
    ...
    {
        id: 'vorpal-sword', name: 'Vorpal Sword', icon: '⚔️', type: 'Magic', rarity: 'Legendary', category: 'Weapon', categories: ['Weapon'], subtype: 'Greatsword',
